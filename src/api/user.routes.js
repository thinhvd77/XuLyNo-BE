...
const createUserValidationRules = [
  ...
  body('dept').isIn(['KHDN', 'KH&QLRR', 'BGĐ']).withMessage('Phòng ban không hợp lệ.'),
  body('role').isIn(['Nhân viên', 'Phó phòng', 'Trưởng phòng', 'Phó giám đốc', 'Giám đốc']).withMessage('Vai trò không hợp lệ.'),
];
